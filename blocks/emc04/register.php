<?php
            ...
            wp_register_style(
                ...
                filemtime(DAF_BLOCKS_PATH.'/blocks/emc04/style.css') // Everytime it is update clear style from cash
            );
            ...
            wp_register_style(
                ...
                array('wp-edit-blocks'), // Dependencies 
                filemtime(DAF_BLOCKS_PATH.'/blocks/emc04/editor-style.css') // Everytime it is update clear style from cash
            );
