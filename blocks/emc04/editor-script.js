...
registerBlockType("daf/emc04", {
  title: "DAF - Dynamic block Main Content 04",
  description: "Three Images accross with headline",
  icon: "visibility",
  category: "common",
  attributes: {
  ...
  edit: function(props) {
    console.log("emc04 - edit-props", props);
    ...
    function updateColumnsOnDesktop(event) {
      ...
      props.setAttributes({
        blockcolumnsondesktop: event.target.value
      });
    }
    ...
    return React.createElement(
      ...
      React.createElement("h3", null, "E-MC-04"),
