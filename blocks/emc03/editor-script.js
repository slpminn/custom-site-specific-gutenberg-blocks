...
registerBlockType( 'daf/emc03', {
	title: 'DAF - Dynamic block Main Content 03',
	description: 'This block will create a list of headlines with no images.',
	icon: 'visibility',
	category: 'common',
	attributes: {
	...
	edit: function(props) {
		...
		return React.createElement(
			...
			React.createElement("h3",null,"E-MC-03"),
